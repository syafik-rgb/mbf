...
def folder():
	...
	try:
		ua_ = 'Mozilla/5.0 (Linux; Android 6.0.1; SM-J500G Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/537.36 GSA/13.7.9.23.arm[FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
...
def masuk():
    ...
    if rom in(""):
    	...
    	try:
        	...
        	print("%s [!] Token hangus anjing "%(M));masuk()
    elif rom in ('2', '02'):
...
class ngentod:
    ...
    def b_api(self, user, zona):
    	try:
        	...
        	ua = 'Mozilla/5.0 (Linux; Android 6.0.1; SM-J500G Build/MMB29M; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/55.0.2883.91 Mobile Safari/537.36 GSA/13.7.9.23.arm[FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]'
        global ok,cp,loop
        for pw in zona:
            pw = pw.lower()
